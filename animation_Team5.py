...
circle, =ax.plot([],[], 'o', markerfacecolor='w', markeredgecolor='yellow',
markersize=15, markeredgewidth = 6)
circle1, =ax.plot([],[], 'o', markerfacecolor='w', markeredgecolor='orange',
markersize=10, markeredgewidth = 3)
circle2, =ax.plot([],[], 'o', markerfacecolor='w', markeredgecolor='red',
markersize=10, markeredgewidth = 2)
circle3, =ax.plot([],[], 'o', markerfacecolor='w', markeredgecolor='blue',
markersize=10, markeredgewidth = 2)
...
def animate(i):
    x = np.linspace(0, 3, 800)
    y = np.cos(3 * np.pi * (x - 0.015 * i))
    #Defining the tan function
    y1 = np.tan(3*np.pi*(x-0.015*i))
    line.set_data(x, y)
    line.set_data(x,y1)
    # ploting the two circles on sin and tan functions
    circle.set_data(x,y)
    circle1.set_data(x,y1)
    circle2.set_data(x,x)
    circle3.set_data(x,-x)
    return line,circle,circle1
